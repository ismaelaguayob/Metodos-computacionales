...
while (offset < total_results) {
  ...
  mutate(
    post_category_primary.name = ifelse("post_category_primary.name" %in% names(json_data$notas), 
                                   json_data$notas$post_category_primary.name, NA),
    post_category_secondary.name = ifelse("post_category_secondary.name" %in% names(json_data$notas), 
