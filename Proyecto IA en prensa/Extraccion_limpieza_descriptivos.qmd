...
-   Te permita devolver los n últimas noticias (ordenadas desde las más recientes)

-   investigar parametros para ver rangos de fecha
...
# Combinamos todas las stopwords en una sola lista
stop_words_total <- unique(c(stop_words, stop_words_es_comunes, stop_words_particulares))
...
wordcloud2(
  data = palabras_positivas_frecuentes, 
  size = 0.3,              # Aumenta el tamaño general de las palabras
  minSize = 0,             # Asegura que todas las palabras sean visibles
  gridSize = 1,            # Ajusta la densidad de palabras
  color = "random-dark",   # Colores para las palabras
...
wordcloud2(
  data = palabras_negativas_frecuentes, 
  size = 0.3,              # Aumenta el tamaño general de las palabras
  minSize = 0,             # Asegura que todas las palabras sean visibles
  gridSize = 1,            # Ajusta la densidad de palabras
  color = "random-dark",   # Colores para las palabras
