...
all_data_updated <- all_data_updated %>%
  mutate(
    predominant_sentiment = sapply(sentiment, function(x) {
      # Filtrar y calcular los puntajes de sentimientos positivos y negativos que superan el umbral
      ...
      # Determinar el sentimiento predominante basado en la suma de los puntajes
...
titulo_grafico <- "Cantidad de Notas por Año y Sentimiento Predominante"
